...
void ExpandedFroom::OnInit(){
    ...
    this->settingsButton.Load(CTTP::buttonFolder, "FroomSettingsButton", "Settings", 1, 0, false);
    ...
    this->teamsButton.Load(CTTP::buttonFolder, "FroomSettingsButton", "Teams", 1, 0, false);
